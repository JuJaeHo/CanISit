...
public class MyList_info_Adapter extends BaseAdapter {
	Context context;
	int itemlayout;
	ArrayList<MyList_info_Item> arrayItems;
	LayoutInflater inflater;

	public MyList_info_Adapter(Context c, int sublayout,
			ArrayList<MyList_info_Item> list) {
		this.context = c;
