...
public class BusStop_info_Adapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		busNumber.setText(arrayItems.get(position).getBusNumberText());
		busType.setText(arrayItems.get(position).getBusTypeText());
		busLeftTime.setText(arrayItems.get(position).getBusLeftTimeText());
			...
			public void onClick(View v) {
				...
				Toast.makeText(
						...
						busNumber.getText() + "/" + busType.getText() + "/"
								+ busLeftTime.getText() + "; This is in the adapter class", Toast.LENGTH_LONG)
						.show();
