...
public class BusStopFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		final View rootView = inflater.inflate(R.layout.fragment_busstop,
				container, false);
		...
		// in the same question.. upper WEB
		// ((Activity) rootView.getContext()).getWindow().setSoftInputMode(
		...
		// @Override
		// public void run() {
		// InputMethodManager keyboard = (InputMethodManager) rootView
