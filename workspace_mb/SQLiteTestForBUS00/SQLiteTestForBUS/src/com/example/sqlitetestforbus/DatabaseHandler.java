...
public class DatabaseHandler extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		String CREATE_CONTACTS_TABLE = "CREATE TABLE " + TABLE_CONTACTS + "("
				...
				+ KEY_ARSID + " TEXT," + KEY_RTNM + " TEXT," + KEY_STNM
				+ " TEXT" + ")";
	...
	public List<BusInfo> getAllContacts() {
		...
		if (cursor.moveToFirst()) {
			do {
				...
				contact.setInfo(cursor.getString(1));
				contact.setArsId(cursor.getString(2));
				contact.setRtNm(cursor.getString(3));
				contact.setStNm(cursor.getString(4));
